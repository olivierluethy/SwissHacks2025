...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true)
        // Get the first submission as default (in a real app, this would be based on route params)
        const submissionData = getSubmissionById("florida-2024")
        setSubmission(submissionData)

        // Fetch dashboard data
        const data = await dashboardService.getDashboardData("florida-2024")
  ...
  if (!dashboardData || !submission) {
    return (
      <div className="flex flex-col items-center justify-center h-screen">
        ...
        <p className="text-gray-600">No submission or dashboard data found.</p>
      </div>
    )
  }
      ...
      <div className="bg-white border-b border-gray-200 py-2 px-4">
        <div className="flex flex-wrap items-center justify-between">
          <div className="flex items-center space-x-4">
            <h2 className="text-lg font-semibold text-gray-800">{submission.name}</h2>
            <span className="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs font-medium">
              {submission.status === "complete" ? "Analysis Complete" : "In Progress"}
            </span>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center">
            <div>
              ...
              <div className="flex items-center mb-2">
                <span className="font-medium text-blue-600 mr-2">{dashboardData.underwriterResponse.decision}:</span>
                <span>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {dashboardData.layerData.map((layer: any, index: number) => (
                        <tr key={index} className={layer.name === "Layer 2" ? "bg-blue-50" : ""}>
                          ...
                          <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-500">${layer.attachment}M</td>
                          ...
                          <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-500">${layer.expectedLoss}M</td>
                          <td
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {dashboardData.contractChanges.map((change: any, index: number) => (
                    <tr key={index}>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{change.clause}</td>
              ...
              <div>
                ...
                <div className="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-500">
                  ...
                  <p className="text-gray-700">
                    ...
                    territory restrictions, and enhanced reporting requirements. Overall risk reduction is estimated at
                    12% compared to the 2023 contract.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Construction costs remain elevated at 35% above 2017 baseline, impacting property repair and
                          replacement costs.
                        </p>
                      </div>
                    </li>
                ...
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={dashboardData.hurricaneData}>
                      ...
                      />
                      <Line yAxisId="right" type="monotone" dataKey="severity" stroke="#82ca9d" name="Severity Index" />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
              </div>
              ...
              <div>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Contract exclusion of Monroe County and coastal areas reduces exposure to highest climate risk
                          zones.
                        </p>
                      </div>
                    </li>
                ...
                <div className="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-500">
                  ...
                  <p className="text-gray-700">
                    ...
                    enhanced Category 5 hurricane exclusions provide significant mitigation. The 1-year contract term
                    limits exposure to long-term climate trends.
                  </p>
                </div>
              </div>
            </div>
